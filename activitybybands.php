...
<head>
	...
	<link rel="stylesheet"
		href="<?php echo URL; ?>assets/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css"
		type='text/css' />
							...
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-md-9 text-right">
										<form class="form-inline table-inline-filter" method="POST"
											action="activitybybands.php">
											...
											<div class="form-group">
												<select class="form-control" id="team" name="team">
													<?php foreach ($data['teamslist'] as $k => $v) { ?>
														...
														<option value="<?php echo $v['id']; ?>" <?php if ($selectedteam == $v['id']) {
															   echo 'selected';
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-4 col-sm-4 text-center">
									<div id="donut-chart-2" style="height: 240px; min-width:240px; margin:0px auto;">
									</div>
								</div>
								<div class="col-md-4 col-sm-4 text-center">
									<div id="donut-chart-3" style="height: 240px; min-width:240px; margin:0px auto;">
									</div>
								</div>
								<div class="col-md-4 col-sm-4 text-center">
									<div id="donut-chart-4" style="height: 240px; min-width:240px; margin:0px auto;">
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-md-12">
					<div class="panel panel-chart">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-4 col-sm-4 text-center">
									<div id="donut-chart-5" style="height: 240px; min-width:240px; margin:0px auto;">
									</div>
								</div>
								<div class="col-md-4 col-sm-4 text-center">
									<div id="donut-chart-6" style="height: 240px; min-width:240px; margin:0px auto;">
									</div>
								</div>
								<div class="col-md-4 col-sm-4 text-center">
									<div id="donut-chart-7" style="height: 240px; min-width:240px; margin:0px auto;">
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-md-12">
					<div class="panel panel-chart">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-4 col-sm-4 text-center">
									<div id="donut-chart-8" style="height: 240px; min-width:240px; margin:0px auto;">
									</div>
								</div>
								<div class="col-md-4 col-sm-4 text-center">
								...
								<div class="col-md-4 col-sm-4 text-center">
									<div id="donut-chart-10" style="height: 240px; min-width:240px; margin:0px auto;">
									</div>
								</div>
							</div>
						</div>
