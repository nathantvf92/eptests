						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12 col-sm-12 text-center">
									...
									<div id="col-chart-12" style="height: 250px; min-width:90px; width:100%; margin:0px auto;"></div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12 col-sm-12 text-center">
									...
									<div id="col-chart-13" style="height: 250px; min-width:90px; width:100%; margin:0px auto;"></div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12 col-sm-12 text-center">
									...
									<div id="col-chart-14" style="height: 250px; min-width:90px; width:100%; margin:0px auto;"></div>
								</div>
							</div>
						</div>
					</div>
...
$(function () {
    ...
    xAxis: {
        categories: [ <?php foreach($data['physiobyward'] as $k=>$v){
  ...
  gridLineDashStyle: 'longdash',
    ...
    series: [{
        name: 'F:F',
        data: [<?php foreach($data['physiobyward']  as $k=>$v){
            echo ($v['f2f'] == "")? '0'.',' : $v['f2f'].',';
		} ?>]
...
Highcharts.chart('col-chart-11', {
    ...
    series: [{
        ...
        data: [
            ['F:F', <?php
 			foreach($data['physiototal'] as $k=>$v){
                    if($k == 'f2f'){
                    echo $v;
                }
			}
            if(empty($data['physiototal'])){ echo 0; }
			?>],
            ['NoN F:F', <?php
            foreach($data['physiototal'] as $k=>$v){
                if($k == 'nonf2f'){
    ...
    xAxis: {
        categories: [ <?php foreach($data['otbyward'] as $k=>$v){
...
legend: {
    ...
    series: [{
        name: 'F:F',
        data: [<?php foreach($data['otbyward'] as $k=>$v){
   					echo ($v['f2f'] == "")? '0'.',' : $v['f2f'].',';
 			} ?>]
...
Highcharts.chart('col-chart-12', {
    ...
    series: [{
        ...
        data: [
            ['F:F', <?php
 			foreach($data['otbywardtotal'] as $k=>$v){
 					if($k == 'f2f'){
            echo $v;
          }
            ...
            if(empty($data['otbywardtotal'])){ echo 0; }
			?>],
            ['NoN F:F', <?php
            foreach($data['otbywardtotal'] as $k=>$v){
       					if($k == 'nonf2f'){
    ...
    xAxis: {
        categories: [
          <?php foreach($data['techbyward'] as $k=>$v){
     				echo "'".$v['ward']."',";
 		       }?>
		],
        crosshair: true
...
legend: {
    ...
    series: [{
        ...
        name: 'NON F:F',
        data: [<?php foreach($data['techbyward'] as $k=>$v){
     				echo ($v['nonf2f'] == "")? '0'.',' : $v['nonf2f'].',';
         }?>]
...
Highcharts.chart('col-chart-13', {
    ...
    series: [{
        ...
        data: [
            ['F:F', <?php
 			foreach($data['techbywardtotal'] as $k=>$v){
        if($k != 'f2f'){
          echo $v;
        }
			}
            
            if(empty($data['techbywardtotal'])){ echo 0; }
    ...
    title: {
        text: 'Dieticians by Ward'
    },
    xAxis: {
        categories: [
          <?php foreach($data['dieticianbyward'] as $k=>$v){
     				echo "'".$v['ward']."',";
 		       }?>
		],
        crosshair: true
...
legend: {
    ...
    series: [{
        ...
        name: 'NON F:F',
        data: [<?php foreach($data['dieticianbyward'] as $k=>$v){
     				echo ($v['nonf2f'] == "")? '0'.',' : $v['nonf2f'].',';
         }?>]
...
Highcharts.chart('col-chart-14', {
    ...
    series: [{
        ...
        data: [
            ['F:F', <?php
 			foreach($data['dieticianbywardtotal'] as $k=>$v){
        if($k != 'f2f'){
          echo $v;
        }
			}
            
            if(empty($data['dieticianbywardtotal'])){ echo 0; }
