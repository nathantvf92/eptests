...
$(function () {
	...
	subtitle: { 
		text: 'Total Direct Contacts are <?php echo $data['totaldirectcontacts']; ?>'
	},
    xAxis: {
        categories: [ <?php foreach($data['directcontacts'] as $k=>$v){ 
				echo "'".$k."',";
		}?>
		],
        crosshair: true
  ...
  gridLineDashStyle: 'longdash',
    ...
    series: [{
        ...
        data: [<?php foreach($data['directcontacts'] as $k=>$v){  
				echo $v['total'].",";
		} ?>]
